...
function copyRoom() {
    ...
    navigator.clipboard.writeText(tmpInput.value).then(() => {
        ...
        popupMessage(
            'clean',
            'Video room joining QR',
            `<div id="qrRoomContainer">
                <canvas id="qrRoom"></canvas>
            </div>
            <br/>
            <p style="color:rgb(8, 189, 89);">Join from your mobile device</p>
            <p style="background:transparent; color:white; font-family: Arial, Helvetica, sans-serif;">Scan/share the QR code with your mobile camera Or Invite client to join by sending them the following URL</p>
